...
streambed transformer add \
  ...
  --outlet-topic rtc-data-up-json battery-data-up-json solar-data-up-json stem-diameter-data-up-json stem-temperature-data-up-json vwc-count-data-up-json temperature-data-up-json ec-data-up-json vwc-data-up-json \
  --source - < ./ict-soil-dendrometer-probe/transformers/main/source.js
